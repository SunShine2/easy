...
function(){
	console.log("login...");
	page.open("http://admin.cloudapp.aliyun.com/manage/manage.php");
...
function(){
	...
	page.open("http://admin.cloudapp.aliyun.com/manage/manage.php/app?app_id=" + id + "&name=&category=&newapp=&status=&admin=&tyuid=&system=");
},
function(){
...
function(){
	console.log("edit...");
	page.open("http://admin.cloudapp.aliyun.com/manage/manage.php/app/edit/id/" + id);
},
function(){
    if(!version){
        return;
...
function(){
	page.open("http://admin.cloudapp.aliyun.com/manage/manage.php/app/publish/id/" + id);
},
function(){
	page.evaluate(function() {
		window.confirm = function(){
